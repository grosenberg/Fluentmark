...
public class LinkRefTab extends AbstractLinkTab {
	...
	public LinkRefTab(LinksInfo info, int idx) {
		super(info, idx, SpecializedType.Link, SpecSubType.REF);
	}
	...
	protected String getLinkText() {
		...
		if (txt.isEmpty()) return String.format("[%s][]", ref);
