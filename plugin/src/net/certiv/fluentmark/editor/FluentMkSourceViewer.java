...
public class FluentMkSourceViewer extends ProjectionViewer implements IPropertyChangeListener {
	...
	public void configure(SourceViewerConfiguration configuration) {
		...
		if (configuration instanceof FluentMkSourceViewerConfiguration) {
			...
			// FluentMkSourceViewerConfiguration cConfiguration = (FluentMkSourceViewerConfiguration)
			// configuration;
			//
