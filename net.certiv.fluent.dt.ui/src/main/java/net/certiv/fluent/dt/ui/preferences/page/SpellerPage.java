...
import net.certiv.fluent.dt.ui.preferences.blocks.SpellingConfigBlock;
...
public class SpellerPage extends AbstractPreferencePage {
	...
	protected IPreferenceConfigBlock createConfigurationBlock(PrefsDeltaManager delta) {
		return new SpellingConfigBlock(this, delta, getFormkit(), getColorRegistry(), new StatusMonitor());
	}
