...
import net.certiv.dsl.core.util.SWTFactory;
...
public class PdfDialog extends MessageDialog {
	...
	protected Control createCustomArea(Composite parent) {
		Composite comp = SWTFactory.makeComposite(parent, 1, 3);

		// Template select ------------------------------

		SWTFactory.makeLabel(comp, "Template:", 1);

		txtTmpl = SWTFactory.makeText(comp, 1);
		...
		SWTFactory.makeLabel(comp, "Save to:", 1);

		txtSave = SWTFactory.makeText(comp, 1);
