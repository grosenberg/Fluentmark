...
public class Prefs extends PrefsSpelling {
	...
	public static final String MD_ID = "fluentmark";
	public static final String EDITOR_TAB_WIDTH = MD_ID + ".tabWidth";
	public static final String EDITOR_TAB_CHAR = MD_ID + ".tabChar";
	...
	public static final String EDITOR_KEYWORDS_COLOR = MD_ID + ".keyWords"; //$NON-NLS-1$
	...
	// @formatter:on
	public static final String KEY_DOT = MD_ID + ".dot";
	public static final String KEY_UML = MD_ID + ".uml";
	public static final String KEY_MARDOWNJ = MD_ID + ".markdownJ";
	public static final String KEY_BLACKFRIDAY = MD_ID + ".blackFriday";
	public static final String KEY_CMARK = MD_ID + ".commonmark";
	...
	public static final String EDITOR_FORMATTING_UNWRAP = MD_ID + ".formattingUnwrap";
	...
	public static final String EDITOR_CORRECTION_INDICATION = MD_ID + ".correction";
	 ...
	 */
	public static final String CODEASSIST_AUTOACTIVATION = MD_ID + ".content_assist_autoactivation"; //$NON-NLS-1$

	/**
	 * A name preference that holds the auto activation delay time in milliseconds.
	 */
	public static final String CODEASSIST_AUTOACTIVATION_DELAY = MD_ID + ".content_assist_autoactivation_delay"; //$NON-NLS-1$

	/**
	 * A named preference that controls if code assist contains only visible proposals.
	 */
	public static final String CODEASSIST_SHOW_VISIBLE_PROPOSALS = MD_ID + ".content_assist_show_visible_proposals"; //$NON-NLS-1$

	/**
	 * A named preference that controls if the code assist inserts a proposal automatically if only one
	 * proposal is available.
	 */
	public static final String CODEASSIST_AUTOINSERT = MD_ID + ".content_assist_autoinsert"; //$NON-NLS-1$
	 ...
	 */
	public static final String CODEASSIST_INSERT_COMPLETION = MD_ID + ".content_assist_insert_completion"; //$NON-NLS-1$

	/**
	 * A named preference that controls whether code assist proposals filtering is case sensitive or
	 * not.
	 */
	public static final String CODEASSIST_CASE_SENSITIVITY = MD_ID + ".content_assist_case_sensitivity"; //$NON-NLS-1$
	 ...
	 */
	public static final String CODEASSIST_FILL_ARGUMENT_NAMES = MD_ID + ".content_assist_fill_method_arguments"; //$NON-NLS-1$

	/**
	 * A named preference that controls if content assist inserts the common prefix of all proposals
	 * before presenting choices.
	 */
	public static final String CODEASSIST_PREFIX_COMPLETION = MD_ID + ".content_assist_prefix_completion"; //$NON-NLS-1$

	/**
	 * A named preference that holds the characters that auto activate code assist in Markdown.
	 */
	public static final String CODEASSIST_AUTOACTIVATION_TRIGGERS_MD = MD_ID
	 ...
	 */
	public static final String CODEASSIST_AUTOACTIVATION_TRIGGERS_DOT = MD_ID
			+ ".content_assist_autoactivation_triggers_dot"; //$NON-NLS-1$

	/**
	 * A named preference that holds the background color used for parameter hints.
	 */
	public static final String CODEASSIST_PARAMETERS_BACKGROUND = MD_ID + ".content_assist_parameters_background"; //$NON-NLS-1$

	/**
	 * A named preference that holds the foreground color used in the code assist selection dialog.
	 */
	public static final String CODEASSIST_PARAMETERS_FOREGROUND = MD_ID + ".content_assist_parameters_foreground"; //$NON-NLS-1$

	/**
	 * A named preference that holds the background color used in the code assist selection dialog to
	 * mark replaced code.
	 */
	public static final String CODEASSIST_REPLACEMENT_BACKGROUND = MD_ID
	 ...
	 * mark replaced code.
	 */
	public static final String CODEASSIST_REPLACEMENT_FOREGROUND = MD_ID
			+ ".content_assist_completion_replacement_foreground"; //$NON-NLS-1$

	/**
	 * Code assist option ID: Activate Visibility Sensitive Completion.
	 */
	public static final String CODEASSIST_VISIBILITY_CHECK = MD_ID + ".codeComplete.visibilityCheck"; //$NON-NLS-1$
}
