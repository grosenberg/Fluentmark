...
public class TextFormatter {
	 ...
	 * formatting. The method <i>assumes</i> that if the first line ends with a line termination
	...
	/**
	 * Formats a string of text. The formatting does line wrapping at the <code>lineWidth</code>
