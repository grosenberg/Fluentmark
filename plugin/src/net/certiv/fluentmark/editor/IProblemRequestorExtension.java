...
public interface IProblemRequestorExtension {
	...
	/**
	 * Informs the problem requestor that a sequence of reportings is about to start. While a
	 * sequence is active, multiple peering calls of <code>beginReporting</code> and
