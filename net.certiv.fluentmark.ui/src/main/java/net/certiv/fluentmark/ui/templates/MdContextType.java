...
public class MdContextType extends DslTemplateContextType {
	...
	public static final String CONTEXT_TYPE_ID = "net.certiv.fluentmark.ui.templates";
	public static final String CUSTOM_TEMPLATES_KEY = "net.certiv.fluentmark.ui.CustomContext.templates";
