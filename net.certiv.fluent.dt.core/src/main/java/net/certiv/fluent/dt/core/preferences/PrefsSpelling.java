...
public class PrefsSpelling extends DslPrefsKey {
	 ...
	 * ignored.
	 */
	public static final String SPELLING_IGNORE_AMPERSAND_IN_PROPERTIES = "spelling_ignore_ampersand_in_properties"; //$NON-NLS-1$
	 ...
	 * checking.
	 */
	public static final String SPELLING_PROPOSAL_THRESHOLD = "spelling_proposal_threshold"; //$NON-NLS-1$

	/**
	 * A named preference that controls the maximum number of problems reported
	 * during spell checking.
	 */
	public static final String SPELLING_PROBLEMS_THRESHOLD = "spelling_problems_threshold"; //$NON-NLS-1$
	 ...
	 */
	public static final String SPELLING_USER_DICTIONARY_ENCODING = "spelling_user_dictionary_encoding"; //$NON-NLS-1$

	/**
	 * A named preference that specifies whether spelling dictionaries are available
	 * to content assist. <strong>Note:</strong> This is currently not supported
	 * because the spelling engine cannot return word proposals but only correction
	 * proposals.
	 */
	public static final String SPELLING_ENABLE_CONTENTASSIST = "spelling_enable_contentassist"; //$NON-NLS-1$
