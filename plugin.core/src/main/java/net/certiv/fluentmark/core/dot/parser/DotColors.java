...
/**
 * The color information contained by this class has been taken from the graphviz website:
...
public class DotColors {
	...
	/**
	 * Returns the valid dot color names defined within the given <i>colorScheme</i>.
	 *
	 * @param colorScheme The name of the color scheme.
	 * @return The list of valid dot color names defined within the given <i>colorScheme</i>.
	 */
	...
	/**
	 * Calculates the detailed description in html form providing more information about the given
	 * color.
	 *
	...
	/**
	 * Returns the color code (in hexadecimal form) of the given <i>colorName</i> considering the given
	 * <i>colorScheme</i>, or null if the color code cannot be determined.
	 *
	 * @param colorScheme The name of the color scheme.
