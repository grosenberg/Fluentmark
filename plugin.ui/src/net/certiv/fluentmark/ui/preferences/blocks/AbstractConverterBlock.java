...
public abstract class AbstractConverterBlock {

	private static final List<FieldEditor> actives = new ArrayList<>();

	private ConvertersPage page;
	private Composite comp;
	private boolean visible;

	public AbstractConverterBlock(ConvertersPage page, Composite parent, String title) {
		this.page = page;
		this.comp = SWTFactory.makeGroupComposite(parent, 3, 3, title);

		createControls(comp);
	}

	public ConvertersPage getPage() {
		return page;
	}
