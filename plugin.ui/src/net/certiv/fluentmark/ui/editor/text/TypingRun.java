...
public final class TypingRun {
	...
	/**
	 * A change of type <code>OVERTYPE</code> replaces one single character (overwrite mode, pasting
	 * a single character).
	 */
	...
	public static final class ChangeType {
		 ...
		 *
		 * @return <code>true</code> if changes of this type modify text, <code>false</code>
		 *         otherwise
		 */
