...
public class FluentMkTextTools {
	...
	public FluentMkTextTools(boolean autoDispose) {
	 ...
	 * this collection.
	 */
	public FluentMkTextTools(String partitioning, String[] legalContentTypes, boolean autoDispose) {
	...
	public SourceViewerConfiguration createSourceViewerConfiguraton(IPreferenceStore store, ITextEditor editor,
			String partitioning) {
		return new FluentMkSourceViewerConfiguration(getColorMgr(), store, editor, partitioning);
	}
	...
	public SourceViewerConfiguration createSimpleSourceViewerConfiguration(IPreferenceStore store,
			String partitioning) {
		return new FluentMkSimpleSourceViewerConfiguration(getColorMgr(), store, null, partitioning, false);
	}

	private IColorManager getColorMgr() {
		return FluentMkUI.getDefault().getColorMgr();
	}
