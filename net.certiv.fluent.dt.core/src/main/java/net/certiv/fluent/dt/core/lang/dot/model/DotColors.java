...
public class DotColors {
	...
	private static Map<String, String> x11ColorScheme = ImmutableMap.<String, String>builder()
			.put("aliceblue", "#f0f8ff") //$NON-NLS-1$ //$NON-NLS-2$
	...
	private static Map<String, String> svgColorScheme = ImmutableMap.<String, String>builder()
			.put("aliceblue", "#f0f8ff") //$NON-NLS-1$ //$NON-NLS-2$
	...
	private static Map<String, String[]> brewerColorSchemes = ImmutableMap.<String, String[]>builder()
			.put("accent3", new String[] //$NON-NLS-1$
			{ "#7fc97f", "#beaed4", "#fdc086" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("accent4", //$NON-NLS-1$
					new String[]
					{ "#7fc97f", "#beaed4", "#fdc086", "#ffff99" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("blues3", new String[] //$NON-NLS-1$
			{ "#deebf7", "#9ecae1", "#3182bd" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("blues4", //$NON-NLS-1$
					new String[]
					{ "#eff3ff", "#bdd7e7", "#6baed6", "#2171b5" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("blues5", //$NON-NLS-1$
					new String[]
					{ "#eff3ff", "#bdd7e7", "#6baed6", "#3182bd", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#08519c" }) //$NON-NLS-1$
			.put("blues6", //$NON-NLS-1$
					new String[]
					{ "#eff3ff", "#c6dbef", "#9ecae1", "#6baed6", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("blues8", //$NON-NLS-1$
					new String[]
					{ "#f7fbff", "#deebf7", "#c6dbef", "#9ecae1", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("brbg10", //$NON-NLS-1$
					new String[]
					{ "#543005", "#8c510a", "#bf812d", "#dfc27d", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("brbg3", new String[] //$NON-NLS-1$
			{ "#d8b365", "#f5f5f5", "#5ab4ac" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("brbg4", //$NON-NLS-1$
					new String[]
					{ "#a6611a", "#dfc27d", "#80cdc1", "#018571" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("brbg5", //$NON-NLS-1$
					new String[]
					{ "#a6611a", "#dfc27d", "#f5f5f5", "#80cdc1", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#018571" }) //$NON-NLS-1$
			.put("brbg6", //$NON-NLS-1$
					new String[]
					{ "#8c510a", "#d8b365", "#f6e8c3", "#c7eae5", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#5ab4ac", "#01665e" }) //$NON-NLS-1$ //$NON-NLS-2$
			.put("brbg7", //$NON-NLS-1$
					new String[]
					{ "#8c510a", "#d8b365", "#f6e8c3", "#f5f5f5", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#c7eae5", "#5ab4ac", "#01665e" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("brbg8", //$NON-NLS-1$
					new String[]
					{ "#8c510a", "#bf812d", "#dfc27d", "#f6e8c3", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("brbg9", //$NON-NLS-1$
					...
					{ "#8c510a", "#bf812d", "#dfc27d", "#f6e8c3", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#01665e" }) //$NON-NLS-1$
			.put("bugn3", new String[] //$NON-NLS-1$
			{ "#e5f5f9", "#99d8c9", "#2ca25f" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("bugn4", //$NON-NLS-1$
					new String[]
					{ "#edf8fb", "#b2e2e2", "#66c2a4", "#238b45" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("bugn5", //$NON-NLS-1$
					new String[]
					{ "#edf8fb", "#b2e2e2", "#66c2a4", "#2ca25f", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#006d2c" }) //$NON-NLS-1$
			.put("bugn6", //$NON-NLS-1$
					new String[]
					{ "#edf8fb", "#ccece6", "#99d8c9", "#66c2a4", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("bugn8", //$NON-NLS-1$
					new String[]
					{ "#f7fcfd", "#e5f5f9", "#ccece6", "#99d8c9", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("bugn9", //$NON-NLS-1$
					...
					{ "#f7fcfd", "#e5f5f9", "#ccece6", "#99d8c9", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#00441b" }) //$NON-NLS-1$
			.put("bupu3", new String[] //$NON-NLS-1$
			{ "#e0ecf4", "#9ebcda", "#8856a7" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("bupu4", //$NON-NLS-1$
					new String[]
					{ "#edf8fb", "#b3cde3", "#8c96c6", "#88419d" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("bupu5", //$NON-NLS-1$
					new String[]
					{ "#edf8fb", "#b3cde3", "#8c96c6", "#8856a7", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#810f7c" }) //$NON-NLS-1$
			.put("bupu6", //$NON-NLS-1$
					new String[]
					{ "#edf8fb", "#bfd3e6", "#9ebcda", "#8c96c6", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("bupu8", //$NON-NLS-1$
					new String[]
					{ "#f7fcfd", "#e0ecf4", "#bfd3e6", "#9ebcda", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("bupu9", //$NON-NLS-1$
					...
					{ "#f7fcfd", "#e0ecf4", "#bfd3e6", "#9ebcda", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#4d004b" }) //$NON-NLS-1$
			.put("dark23", new String[] //$NON-NLS-1$
			{ "#1b9e77", "#d95f02", "#7570b3" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("dark24", //$NON-NLS-1$
					new String[]
					{ "#1b9e77", "#d95f02", "#7570b3", "#e7298a" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("gnbu3", new String[] //$NON-NLS-1$
			{ "#e0f3db", "#a8ddb5", "#43a2ca" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("gnbu4", //$NON-NLS-1$
					new String[]
					{ "#f0f9e8", "#bae4bc", "#7bccc4", "#2b8cbe" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("gnbu5", //$NON-NLS-1$
					new String[]
					{ "#f0f9e8", "#bae4bc", "#7bccc4", "#43a2ca", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#0868ac" }) //$NON-NLS-1$
			.put("gnbu6", //$NON-NLS-1$
					new String[]
					{ "#f0f9e8", "#ccebc5", "#a8ddb5", "#7bccc4", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("gnbu8", //$NON-NLS-1$
					new String[]
					{ "#f7fcf0", "#e0f3db", "#ccebc5", "#a8ddb5", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("gnbu9", //$NON-NLS-1$
					...
					{ "#f7fcf0", "#e0f3db", "#ccebc5", "#a8ddb5", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#084081" }) //$NON-NLS-1$
			.put("greens3", new String[] //$NON-NLS-1$
			{ "#e5f5e0", "#a1d99b", "#31a354" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("greens4", //$NON-NLS-1$
					new String[]
					{ "#edf8e9", "#bae4b3", "#74c476", "#238b45" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("greens5", //$NON-NLS-1$
					new String[]
					{ "#edf8e9", "#bae4b3", "#74c476", "#31a354", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#006d2c" }) //$NON-NLS-1$
			.put("greens6", //$NON-NLS-1$
					new String[]
					{ "#edf8e9", "#c7e9c0", "#a1d99b", "#74c476", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("greens8", //$NON-NLS-1$
					new String[]
					{ "#f7fcf5", "#e5f5e0", "#c7e9c0", "#a1d99b", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("greens9", //$NON-NLS-1$
					...
					{ "#f7fcf5", "#e5f5e0", "#c7e9c0", "#a1d99b", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#00441b" }) //$NON-NLS-1$
			.put("greys3", new String[] //$NON-NLS-1$
			{ "#f0f0f0", "#bdbdbd", "#636363" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("greys4", //$NON-NLS-1$
					new String[]
					{ "#f7f7f7", "#cccccc", "#969696", "#525252" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("greys5", //$NON-NLS-1$
					new String[]
					{ "#f7f7f7", "#cccccc", "#969696", "#636363", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#252525" }) //$NON-NLS-1$
			.put("greys6", //$NON-NLS-1$
					new String[]
					{ "#f7f7f7", "#d9d9d9", "#bdbdbd", "#969696", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("greys8", //$NON-NLS-1$
					new String[]
					{ "#ffffff", "#f0f0f0", "#d9d9d9", "#bdbdbd", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("greys9", //$NON-NLS-1$
					...
					{ "#ffffff", "#f0f0f0", "#d9d9d9", "#bdbdbd", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#969696", "#737373", "#525252", "#252525", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#000000" }) //$NON-NLS-1$
			.put("oranges3", new String[] //$NON-NLS-1$
			{ "#fee6ce", "#fdae6b", "#e6550d" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("oranges4", //$NON-NLS-1$
					new String[]
					{ "#feedde", "#fdbe85", "#fd8d3c", "#d94701" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("oranges5", //$NON-NLS-1$
					new String[]
					{ "#feedde", "#fdbe85", "#fd8d3c", "#e6550d", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#a63603" }) //$NON-NLS-1$
			.put("oranges6", //$NON-NLS-1$
					new String[]
					{ "#feedde", "#fdd0a2", "#fdae6b", "#fd8d3c", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("oranges8", //$NON-NLS-1$
					new String[]
					{ "#fff5eb", "#fee6ce", "#fdd0a2", "#fdae6b", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("oranges9", //$NON-NLS-1$
					...
					{ "#fff5eb", "#fee6ce", "#fdd0a2", "#fdae6b", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#7f2704" }) //$NON-NLS-1$
			.put("orrd3", new String[] //$NON-NLS-1$
			{ "#fee8c8", "#fdbb84", "#e34a33" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("orrd4", //$NON-NLS-1$
					new String[]
					{ "#fef0d9", "#fdcc8a", "#fc8d59", "#d7301f" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("orrd5", //$NON-NLS-1$
					new String[]
					{ "#fef0d9", "#fdcc8a", "#fc8d59", "#e34a33", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#b30000" }) //$NON-NLS-1$
			.put("orrd6", //$NON-NLS-1$
					new String[]
					{ "#fef0d9", "#fdd49e", "#fdbb84", "#fc8d59", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("orrd8", //$NON-NLS-1$
					new String[]
					{ "#fff7ec", "#fee8c8", "#fdd49e", "#fdbb84", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("paired10", //$NON-NLS-1$
					new String[]
					{ "#a6cee3", "#1f78b4", "#b2df8a", "#33a02c", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("paired3", new String[] //$NON-NLS-1$
			{ "#a6cee3", "#1f78b4", "#b2df8a" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			...
			.put("paired9", //$NON-NLS-1$
					...
					{ "#a6cee3", "#1f78b4", "#b2df8a", "#33a02c", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#fb9a99", "#e31a1c", "#fdbf6f", "#ff7f00", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#cab2d6" }) //$NON-NLS-1$
			.put("pastel13", new String[] //$NON-NLS-1$
			{ "#fbb4ae", "#b3cde3", "#ccebc5" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("pastel14", //$NON-NLS-1$
					new String[]
					{ "#fbb4ae", "#b3cde3", "#ccebc5", "#decbe4" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("pastel19", //$NON-NLS-1$
					...
					{ "#fbb4ae", "#b3cde3", "#ccebc5", "#decbe4", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#fed9a6", "#ffffcc", "#e5d8bd", "#fddaec", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#f2f2f2" }) //$NON-NLS-1$
			.put("pastel23", new String[] //$NON-NLS-1$
			{ "#b3e2cd", "#fdcdac", "#cbd5e8" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("pastel24", //$NON-NLS-1$
					new String[]
					{ "#b3e2cd", "#fdcdac", "#cbd5e8", "#f4cae4" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("piyg10", //$NON-NLS-1$
					new String[]
					{ "#8e0152", "#c51b7d", "#de77ae", "#f1b6da", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("piyg3", new String[] //$NON-NLS-1$
			{ "#e9a3c9", "#f7f7f7", "#a1d76a" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("piyg4", //$NON-NLS-1$
					new String[]
					{ "#d01c8b", "#f1b6da", "#b8e186", "#4dac26" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("piyg5", //$NON-NLS-1$
					new String[]
					{ "#d01c8b", "#f1b6da", "#f7f7f7", "#b8e186", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#4dac26" }) //$NON-NLS-1$
			.put("piyg6", //$NON-NLS-1$
					new String[]
					{ "#c51b7d", "#e9a3c9", "#fde0ef", "#e6f5d0", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#a1d76a", "#4d9221" }) //$NON-NLS-1$ //$NON-NLS-2$
			.put("piyg7", //$NON-NLS-1$
					new String[]
					{ "#c51b7d", "#e9a3c9", "#fde0ef", "#f7f7f7", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#e6f5d0", "#a1d76a", "#4d9221" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("piyg8", //$NON-NLS-1$
					new String[]
					{ "#c51b7d", "#de77ae", "#f1b6da", "#fde0ef", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("prgn10", //$NON-NLS-1$
					new String[]
					{ "#40004b", "#762a83", "#9970ab", "#c2a5cf", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("prgn3", new String[] //$NON-NLS-1$
			{ "#af8dc3", "#f7f7f7", "#7fbf7b" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("prgn4", //$NON-NLS-1$
					new String[]
					{ "#7b3294", "#c2a5cf", "#a6dba0", "#008837" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("prgn5", //$NON-NLS-1$
					new String[]
					{ "#7b3294", "#c2a5cf", "#f7f7f7", "#a6dba0", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#008837" }) //$NON-NLS-1$
			.put("prgn6", //$NON-NLS-1$
					new String[]
					{ "#762a83", "#af8dc3", "#e7d4e8", "#d9f0d3", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#7fbf7b", "#1b7837" }) //$NON-NLS-1$ //$NON-NLS-2$
			.put("prgn7", //$NON-NLS-1$
					new String[]
					{ "#762a83", "#af8dc3", "#e7d4e8", "#f7f7f7", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#d9f0d3", "#7fbf7b", "#1b7837" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("prgn8", //$NON-NLS-1$
					new String[]
					{ "#762a83", "#9970ab", "#c2a5cf", "#e7d4e8", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("prgn9", //$NON-NLS-1$
					...
					{ "#762a83", "#9970ab", "#c2a5cf", "#e7d4e8", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#1b7837" }) //$NON-NLS-1$
			.put("pubu3", new String[] //$NON-NLS-1$
			{ "#ece7f2", "#a6bddb", "#2b8cbe" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("pubu4", //$NON-NLS-1$
					new String[]
					{ "#f1eef6", "#bdc9e1", "#74a9cf", "#0570b0" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("pubu5", //$NON-NLS-1$
					new String[]
					{ "#f1eef6", "#bdc9e1", "#74a9cf", "#2b8cbe", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#045a8d" }) //$NON-NLS-1$
			.put("pubu6", //$NON-NLS-1$
					new String[]
					{ "#f1eef6", "#d0d1e6", "#a6bddb", "#74a9cf", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("pubu8", //$NON-NLS-1$
					new String[]
					{ "#fff7fb", "#ece7f2", "#d0d1e6", "#a6bddb", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("pubu9", //$NON-NLS-1$
					...
					{ "#fff7fb", "#ece7f2", "#d0d1e6", "#a6bddb", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#023858" }) //$NON-NLS-1$
			.put("pubugn3", new String[] //$NON-NLS-1$
			{ "#ece2f0", "#a6bddb", "#1c9099" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("pubugn4", //$NON-NLS-1$
					new String[]
					{ "#f6eff7", "#bdc9e1", "#67a9cf", "#02818a" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("pubugn5", //$NON-NLS-1$
					new String[]
					{ "#f6eff7", "#bdc9e1", "#67a9cf", "#1c9099", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#016c59" }) //$NON-NLS-1$
			.put("pubugn6", //$NON-NLS-1$
					new String[]
					{ "#f6eff7", "#d0d1e6", "#a6bddb", "#67a9cf", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("pubugn8", //$NON-NLS-1$
					new String[]
					{ "#fff7fb", "#ece2f0", "#d0d1e6", "#a6bddb", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("puor10", //$NON-NLS-1$
					new String[]
					{ "#7f3b08", "#b35806", "#e08214", "#fdb863", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("puor3", new String[] //$NON-NLS-1$
			{ "#f1a340", "#f7f7f7", "#998ec3" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("puor4", //$NON-NLS-1$
					new String[]
					{ "#e66101", "#fdb863", "#b2abd2", "#5e3c99" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("puor5", //$NON-NLS-1$
					new String[]
					{ "#e66101", "#fdb863", "#f7f7f7", "#b2abd2", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#5e3c99" }) //$NON-NLS-1$
			.put("puor6", //$NON-NLS-1$
					new String[]
					{ "#b35806", "#f1a340", "#fee0b6", "#d8daeb", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#998ec3", "#542788" }) //$NON-NLS-1$ //$NON-NLS-2$
			.put("puor7", //$NON-NLS-1$
					new String[]
					{ "#b35806", "#f1a340", "#fee0b6", "#f7f7f7", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#d8daeb", "#998ec3", "#542788" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("puor8", //$NON-NLS-1$
					new String[]
					{ "#b35806", "#e08214", "#fdb863", "#fee0b6", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("puor9", //$NON-NLS-1$
					...
					{ "#b35806", "#e08214", "#fdb863", "#fee0b6", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#542788" }) //$NON-NLS-1$
			.put("purd3", new String[] //$NON-NLS-1$
			{ "#e7e1ef", "#c994c7", "#dd1c77" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("purd4", //$NON-NLS-1$
					new String[]
					{ "#f1eef6", "#d7b5d8", "#df65b0", "#ce1256" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("purd5", //$NON-NLS-1$
					new String[]
					{ "#f1eef6", "#d7b5d8", "#df65b0", "#dd1c77", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#980043" }) //$NON-NLS-1$
			.put("purd6", //$NON-NLS-1$
					new String[]
					{ "#f1eef6", "#d4b9da", "#c994c7", "#df65b0", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("purd8", //$NON-NLS-1$
					new String[]
					{ "#f7f4f9", "#e7e1ef", "#d4b9da", "#c994c7", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("purd9", //$NON-NLS-1$
					...
					{ "#f7f4f9", "#e7e1ef", "#d4b9da", "#c994c7", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#67001f" }) //$NON-NLS-1$
			.put("purples3", new String[] //$NON-NLS-1$
			{ "#efedf5", "#bcbddc", "#756bb1" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("purples4", //$NON-NLS-1$
					new String[]
					{ "#f2f0f7", "#cbc9e2", "#9e9ac8", "#6a51a3" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("purples5", //$NON-NLS-1$
					new String[]
					{ "#f2f0f7", "#cbc9e2", "#9e9ac8", "#756bb1", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#54278f" }) //$NON-NLS-1$
			.put("purples6", //$NON-NLS-1$
					new String[]
					{ "#f2f0f7", "#dadaeb", "#bcbddc", "#9e9ac8", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("purples8", //$NON-NLS-1$
					new String[]
					{ "#fcfbfd", "#efedf5", "#dadaeb", "#bcbddc", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("rdbu10", //$NON-NLS-1$
					new String[]
					{ "#67001f", "#b2182b", "#d6604d", "#f4a582", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("rdbu3", new String[] //$NON-NLS-1$
			{ "#ef8a62", "#f7f7f7", "#67a9cf" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("rdbu4", //$NON-NLS-1$
					new String[]
					{ "#ca0020", "#f4a582", "#92c5de", "#0571b0" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("rdbu5", //$NON-NLS-1$
					new String[]
					{ "#ca0020", "#f4a582", "#f7f7f7", "#92c5de", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#0571b0" }) //$NON-NLS-1$
			.put("rdbu6", //$NON-NLS-1$
					new String[]
					{ "#b2182b", "#ef8a62", "#fddbc7", "#d1e5f0", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#67a9cf", "#2166ac" }) //$NON-NLS-1$ //$NON-NLS-2$
			.put("rdbu7", //$NON-NLS-1$
					new String[]
					{ "#b2182b", "#ef8a62", "#fddbc7", "#f7f7f7", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#d1e5f0", "#67a9cf", "#2166ac" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("rdbu8", //$NON-NLS-1$
					new String[]
					{ "#b2182b", "#d6604d", "#f4a582", "#fddbc7", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("rdgy3", new String[] //$NON-NLS-1$
			{ "#ef8a62", "#ffffff", "#999999" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("rdgy4", //$NON-NLS-1$
					new String[]
					{ "#ca0020", "#f4a582", "#bababa", "#404040" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("rdgy5", //$NON-NLS-1$
					new String[]
					{ "#ca0020", "#f4a582", "#ffffff", "#bababa", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#404040" }) //$NON-NLS-1$
			.put("rdgy6", //$NON-NLS-1$
					new String[]
					{ "#b2182b", "#ef8a62", "#fddbc7", "#e0e0e0", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#999999", "#4d4d4d" }) //$NON-NLS-1$ //$NON-NLS-2$
			.put("rdgy7", //$NON-NLS-1$
					new String[]
					{ "#b2182b", "#ef8a62", "#fddbc7", "#ffffff", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("rdgy9", //$NON-NLS-1$
					...
					{ "#b2182b", "#d6604d", "#f4a582", "#fddbc7", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#4d4d4d" }) //$NON-NLS-1$
			.put("rdpu3", new String[] //$NON-NLS-1$
			{ "#fde0dd", "#fa9fb5", "#c51b8a" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("rdpu4", //$NON-NLS-1$
					new String[]
					{ "#feebe2", "#fbb4b9", "#f768a1", "#ae017e" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("rdpu5", //$NON-NLS-1$
					new String[]
					{ "#feebe2", "#fbb4b9", "#f768a1", "#c51b8a", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#7a0177" }) //$NON-NLS-1$
			.put("rdpu6", //$NON-NLS-1$
					new String[]
					{ "#feebe2", "#fcc5c0", "#fa9fb5", "#f768a1", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("rdpu8", //$NON-NLS-1$
					new String[]
					{ "#fff7f3", "#fde0dd", "#fcc5c0", "#fa9fb5", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("rdylbu10", //$NON-NLS-1$
					new String[]
					{ "#a50026", "#d73027", "#f46d43", "#fdae61", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("rdylbu3", new String[] //$NON-NLS-1$
			{ "#fc8d59", "#ffffbf", "#91bfdb" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("rdylbu4", //$NON-NLS-1$
					new String[]
					{ "#d7191c", "#fdae61", "#abd9e9", "#2c7bb6" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("rdylbu5", //$NON-NLS-1$
					new String[]
					{ "#d7191c", "#fdae61", "#ffffbf", "#abd9e9", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#2c7bb6" }) //$NON-NLS-1$
			.put("rdylbu6", //$NON-NLS-1$
					new String[]
					{ "#d73027", "#fc8d59", "#fee090", "#e0f3f8", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#91bfdb", "#4575b4" }) //$NON-NLS-1$ //$NON-NLS-2$
			.put("rdylbu7", //$NON-NLS-1$
					new String[]
					{ "#d73027", "#fc8d59", "#fee090", "#ffffbf", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#e0f3f8", "#91bfdb", "#4575b4" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("rdylbu8", //$NON-NLS-1$
					new String[]
					{ "#d73027", "#f46d43", "#fdae61", "#fee090", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("rdylgn3", new String[] //$NON-NLS-1$
			{ "#fc8d59", "#ffffbf", "#91cf60" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("rdylgn4", //$NON-NLS-1$
					new String[]
					{ "#d7191c", "#fdae61", "#a6d96a", "#1a9641" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("rdylgn5", //$NON-NLS-1$
					new String[]
					{ "#d7191c", "#fdae61", "#ffffbf", "#a6d96a", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#1a9641" }) //$NON-NLS-1$
			.put("rdylgn6", //$NON-NLS-1$
					new String[]
					{ "#d73027", "#fc8d59", "#fee08b", "#d9ef8b", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#91cf60", "#1a9850" }) //$NON-NLS-1$ //$NON-NLS-2$
			.put("rdylgn7", //$NON-NLS-1$
					new String[]
					{ "#d73027", "#fc8d59", "#fee08b", "#ffffbf", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#d9ef8b", "#91cf60", "#1a9850" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("rdylgn8", //$NON-NLS-1$
					new String[]
					{ "#d73027", "#f46d43", "#fdae61", "#fee08b", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("rdylgn9", //$NON-NLS-1$
					...
					{ "#d73027", "#f46d43", "#fdae61", "#fee08b", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#1a9850" }) //$NON-NLS-1$
			.put("reds3", new String[] //$NON-NLS-1$
			{ "#fee0d2", "#fc9272", "#de2d26" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("reds4", //$NON-NLS-1$
					new String[]
					{ "#fee5d9", "#fcae91", "#fb6a4a", "#cb181d" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("reds5", //$NON-NLS-1$
					new String[]
					{ "#fee5d9", "#fcae91", "#fb6a4a", "#de2d26", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#a50f15" }) //$NON-NLS-1$
			.put("reds6", //$NON-NLS-1$
					new String[]
					{ "#fee5d9", "#fcbba1", "#fc9272", "#fb6a4a", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("reds8", //$NON-NLS-1$
					new String[]
					{ "#fff5f0", "#fee0d2", "#fcbba1", "#fc9272", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("reds9", //$NON-NLS-1$
					...
					{ "#fff5f0", "#fee0d2", "#fcbba1", "#fc9272", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#67000d" }) //$NON-NLS-1$
			.put("set13", new String[] //$NON-NLS-1$
			{ "#e41a1c", "#377eb8", "#4daf4a" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("set14", //$NON-NLS-1$
					new String[]
					{ "#e41a1c", "#377eb8", "#4daf4a", "#984ea3" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("set15", //$NON-NLS-1$
					new String[]
					{ "#e41a1c", "#377eb8", "#4daf4a", "#984ea3", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#ff7f00" }) //$NON-NLS-1$
			...
			.put("set19", //$NON-NLS-1$
					...
					{ "#e41a1c", "#377eb8", "#4daf4a", "#984ea3", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#ff7f00", "#ffff33", "#a65628", "#f781bf", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#999999" }) //$NON-NLS-1$
			.put("set23", new String[] //$NON-NLS-1$
			{ "#66c2a5", "#fc8d62", "#8da0cb" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("set24", //$NON-NLS-1$
					new String[]
					{ "#66c2a5", "#fc8d62", "#8da0cb", "#e78ac3" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("set25", //$NON-NLS-1$
					new String[]
					{ "#66c2a5", "#fc8d62", "#8da0cb", "#e78ac3", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#a6d854" }) //$NON-NLS-1$
			...
			.put("set310", //$NON-NLS-1$
					new String[]
					{ "#8dd3c7", "#ffffb3", "#bebada", "#fb8072", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("set33", new String[] //$NON-NLS-1$
			{ "#8dd3c7", "#ffffb3", "#bebada" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("set34", //$NON-NLS-1$
					new String[]
					{ "#8dd3c7", "#ffffb3", "#bebada", "#fb8072" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("set35", //$NON-NLS-1$
			...
			.put("spectral10", //$NON-NLS-1$
					new String[]
					{ "#9e0142", "#d53e4f", "#f46d43", "#fdae61", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("spectral3", new String[] //$NON-NLS-1$
			{ "#fc8d59", "#ffffbf", "#99d594" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("spectral4", //$NON-NLS-1$
					new String[]
					{ "#d7191c", "#fdae61", "#abdda4", "#2b83ba" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("spectral5", //$NON-NLS-1$
					new String[]
					{ "#d7191c", "#fdae61", "#ffffbf", "#abdda4", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#2b83ba" }) //$NON-NLS-1$
			.put("spectral6", //$NON-NLS-1$
					new String[]
					{ "#d53e4f", "#fc8d59", "#fee08b", "#e6f598", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#99d594", "#3288bd" }) //$NON-NLS-1$ //$NON-NLS-2$
			.put("spectral7", //$NON-NLS-1$
					new String[]
					{ "#d53e4f", "#fc8d59", "#fee08b", "#ffffbf", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#e6f598", "#99d594", "#3288bd" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("spectral8", //$NON-NLS-1$
					new String[]
					{ "#d53e4f", "#f46d43", "#fdae61", "#fee08b", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("spectral9", //$NON-NLS-1$
					...
					{ "#d53e4f", "#f46d43", "#fdae61", "#fee08b", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#3288bd" }) //$NON-NLS-1$
			.put("ylgn3", new String[] //$NON-NLS-1$
			{ "#f7fcb9", "#addd8e", "#31a354" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("ylgn4", //$NON-NLS-1$
					new String[]
					{ "#ffffcc", "#c2e699", "#78c679", "#238443" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("ylgn5", //$NON-NLS-1$
					new String[]
					{ "#ffffcc", "#c2e699", "#78c679", "#31a354", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#006837" }) //$NON-NLS-1$
			.put("ylgn6", //$NON-NLS-1$
					new String[]
					{ "#ffffcc", "#d9f0a3", "#addd8e", "#78c679", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("ylgn8", //$NON-NLS-1$
					new String[]
					{ "#ffffe5", "#f7fcb9", "#d9f0a3", "#addd8e", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("ylgn9", //$NON-NLS-1$
					...
					{ "#ffffe5", "#f7fcb9", "#d9f0a3", "#addd8e", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#004529" }) //$NON-NLS-1$
			.put("ylgnbu3", new String[] //$NON-NLS-1$
			{ "#edf8b1", "#7fcdbb", "#2c7fb8" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("ylgnbu4", //$NON-NLS-1$
					new String[]
					{ "#ffffcc", "#a1dab4", "#41b6c4", "#225ea8" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("ylgnbu5", //$NON-NLS-1$
					new String[]
					{ "#ffffcc", "#a1dab4", "#41b6c4", "#2c7fb8", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#253494" }) //$NON-NLS-1$
			.put("ylgnbu6", //$NON-NLS-1$
					new String[]
					{ "#ffffcc", "#c7e9b4", "#7fcdbb", "#41b6c4", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("ylgnbu8", //$NON-NLS-1$
					new String[]
					{ "#ffffd9", "#edf8b1", "#c7e9b4", "#7fcdbb", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("ylgnbu9", //$NON-NLS-1$
					...
					{ "#ffffd9", "#edf8b1", "#c7e9b4", "#7fcdbb", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#081d58" }) //$NON-NLS-1$
			.put("ylorbr3", new String[] //$NON-NLS-1$
			{ "#fff7bc", "#fec44f", "#d95f0e" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("ylorbr4", //$NON-NLS-1$
					new String[]
					{ "#ffffd4", "#fed98e", "#fe9929", "#cc4c02" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("ylorbr5", //$NON-NLS-1$
					new String[]
					{ "#ffffd4", "#fed98e", "#fe9929", "#d95f0e", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#993404" }) //$NON-NLS-1$
			.put("ylorbr6", //$NON-NLS-1$
					new String[]
					{ "#ffffd4", "#fee391", "#fec44f", "#fe9929", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("ylorbr8", //$NON-NLS-1$
					new String[]
					{ "#ffffe5", "#fff7bc", "#fee391", "#fec44f", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("ylorbr9", //$NON-NLS-1$
					...
					{ "#ffffe5", "#fff7bc", "#fee391", "#fec44f", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							"#662506" }) //$NON-NLS-1$
			.put("ylorrd3", new String[] //$NON-NLS-1$
			{ "#ffeda0", "#feb24c", "#f03b20" })  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			.put("ylorrd4", //$NON-NLS-1$
					new String[]
					{ "#ffffb2", "#fecc5c", "#fd8d3c", "#e31a1c" }) //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			.put("ylorrd5", //$NON-NLS-1$
					new String[]
					{ "#ffffb2", "#fecc5c", "#fd8d3c", "#f03b20", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							"#bd0026" }) //$NON-NLS-1$
			.put("ylorrd6", //$NON-NLS-1$
					new String[]
					{ "#ffffb2", "#fed976", "#feb24c", "#fd8d3c", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			...
			.put("ylorrd8", //$NON-NLS-1$
					new String[]
					{ "#ffffcc", "#ffeda0", "#fed976", "#feb24c", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
