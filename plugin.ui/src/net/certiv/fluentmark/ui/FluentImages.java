...
public class FluentImages extends DslImages {
	...
	public final ImageDescriptor DESC_IMG_MENU_COLLAPSE_ALL = create(locBundle, OBJ, locPrefix + "collapseall.gif"); //$NON-NLS-1$
	public final ImageDescriptor DESC_IMG_MENU_EXPAND_ALL = create(locBundle, OBJ, locPrefix + "expandall.gif"); //$NON-NLS-1$
	...
	// "sec_down.gif"); // //$NON-NLS-1$
	// public final ImageDescriptor DESC_IMG_MENU_UP = create(locBundle, OBJ, locPrefix + "sec_up.gif");
	// //$NON-NLS-1$

	public final ImageDescriptor DESC_IMG_MENU_EXPORT_HTML = create(locBundle, OBJ, locPrefix + "htmlexport.gif"); //$NON-NLS-1$
	public final ImageDescriptor DESC_IMG_MENU_REFRESH = create(locBundle, OBJ, locPrefix + "refresh.gif"); //$NON-NLS-1$
	public final ImageDescriptor DESC_IMG_MENU_SYNC = create(locBundle, OBJ, locPrefix + "sync.png"); //$NON-NLS-1$
	public final ImageDescriptor DESC_IMG_OBJS_UNKNOWN = create(locBundle, OBJ, locPrefix + "unknown_obj.gif"); //$NON-NLS-1$
	...
	public final ImageDescriptor DESC_OBJ_COMMENT = create(locBundle, OBJ, locPrefix + "comment.gif"); //$NON-NLS-1$
	public final ImageDescriptor DESC_OBJ_DEFINITION = create(locBundle, OBJ, locPrefix + "definition.gif"); //$NON-NLS-1$
	...
	public final ImageDescriptor DESC_OBJ_REFERENCE = create(locBundle, OBJ, locPrefix + "url_link.gif"); //$NON-NLS-1$
	...
	public final ImageDescriptor DESC_OBJ_COL_DEL = create(locBundle, OBJ, locPrefix + "col_delete.gif"); //$NON-NLS-1$
	public final ImageDescriptor DESC_OBJ_COL_INS_BEF = create(locBundle, OBJ, locPrefix + "col_insert_before.gif"); //$NON-NLS-1$
	public final ImageDescriptor DESC_OBJ_COL_INS_AFT = create(locBundle, OBJ, locPrefix + "col_insert_after.gif"); //$NON-NLS-1$
	public final ImageDescriptor DESC_OBJ_ROW_DEL = create(locBundle, OBJ, locPrefix + "row_delete.gif"); //$NON-NLS-1$
	public final ImageDescriptor DESC_OBJ_ROW_INS_ABV = create(locBundle, OBJ, locPrefix + "row_insert_above.gif"); //$NON-NLS-1$
	public final ImageDescriptor DESC_OBJ_ROW_INS_BLW = create(locBundle, OBJ, locPrefix + "row_insert_below.gif"); //$NON-NLS-1$

	public final ImageDescriptor DESC_IMG_OBJS_FIXABLE_PROBLEM = create(locBundle, OBJ,
			locPrefix + "quickfix_warning_obj.gif"); //$NON-NLS-1$
	public final ImageDescriptor DESC_IMG_OBJS_FIXABLE_ERROR = create(locBundle, OBJ,
			locPrefix + "quickfix_error_obj.gif"); //$NON-NLS-1$
